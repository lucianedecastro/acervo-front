...
          {/* ✅ MODIFICAÇÃO DE ESTRUTURA PARA SLIDING COM CSS */}
          <div className="carrossel-wrapper"> 
            <div 
              className="carrossel-slides-track" 
              // Move a faixa horizontalmente com base no slide atual
              style={{ transform: `translateX(-${currentSlide * 100}%)` }}
            >
              {carrosselImagens.map((slide, index) => (
                <div 
                  key={index} 
                  className="carrossel-slide" // Todos os slides têm a mesma classe
                >
                  <img 
                    src={slide.url} 
                    alt={slide.legenda} 
