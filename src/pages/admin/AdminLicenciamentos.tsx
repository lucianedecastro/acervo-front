...
import {
  ...
  // Ajustado para o nome correto do DTO que está no seu tipos.ts
...
export default function AdminLicenciamentos() {
  ...
  async function handleBuscar() {
    ...
    try {
      ...
      // Ajustado para 'buscarExtratoConsolidado' conforme definido no seu licenciamentoService
          ...
          <div style={tableContainerStyle}>
            {extrato.transacoes.length === 0 ? (
              ...
              <table style={tableStyle}>
                ...
                <tbody>
                  {/* Ajustado o tipo aqui também para TransacaoLicenciamentoDTO */}
...
function ResumoCard({ titulo, valor, cor }: { titulo: string; valor: string; cor: string }) {
  return (
    <div style={{ background: "#fff", padding: "1.5rem", borderLeft: `6px solid ${cor}`, color: "#333" }}>
      <small>{titulo}</small>
